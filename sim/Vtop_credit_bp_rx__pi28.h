...
#ifndef VERILATED_VTOP_CREDIT_BP_RX__PI28_H_
#define VERILATED_VTOP_CREDIT_BP_RX__PI28_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_credit_bp_rx__pi28 final : public VerilatedModule {
  public:
    ...
    VL_OUT(o_d,27,0);
    VlWide<3>/*95:0*/ __PVT__rdata_e;
    VlUnpacked<IData/*31:0*/, 32> __PVT__gen_vc_logic__BRA__0__KET____DOT__vc_fifo__DOT__fifo_data;
    VlUnpacked<IData/*31:0*/, 32> __PVT__gen_vc_logic__BRA__1__KET____DOT__vc_fifo__DOT__fifo_data;
    VlUnpacked<IData/*31:0*/, 32> __PVT__gen_vc_logic__BRA__2__KET____DOT__vc_fifo__DOT__fifo_data;

    // INTERNAL VARIABLES
    Vtop__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vtop_credit_bp_rx__pi28(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_credit_bp_rx__pi28();
    VL_UNCOPYABLE(Vtop_credit_bp_rx__pi28);
