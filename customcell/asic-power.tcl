...
read_verilog asic-post-par.$asictop.$datawidth.v
current_design ${asictop}_D_W$datawidth
link_design

# make this clock synced with constraints.sdc!
create_clock clk -name ideal_clock1 -period 6

source asic-post-synth.$asictop.$datawidth.namemap

read_saif "${asictop}_D_W$datawidth.saif" -strip_path "TOP/top/dut"

read_parasitics -format spef "post-par.$asictop.$datawidth.spef"

update_power

report_power -nosplit             > asic-post-par-power.$asictop.$datawidth.rpt
#report_power -nosplit -hierarchy  > power-hier.rpt
