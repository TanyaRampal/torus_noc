...
source customcell/cells_tx.tcl

# allows NCH models to use larger W/L combinations
...
read_spice -format spectre "./customcell/models/models_$env(PROCESS) spice/low_swing_tx_schematic.sp"

char_library -extsim spectre -cells $cells -thread 50
write_ldb low_swing_tx.ldb
write_library -driver_waveform -user_data low_swing_tx_user_data.lib "low_swing_tx_$env(CORNER)"
